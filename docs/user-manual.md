...
$$\mathbf{\varepsilon}_{1}\left( f_{1},f_{2} \right)\sim MVN\left( \mathbf{0},\mathbf{R}_{1} \right)$$
...
$$r_{2}(i) = \frac{a_{i} \times \exp\left( p_{1}(i) \right)}{r_{1}(i)} \times \exp\left( p_{2}(i) \right)$$
